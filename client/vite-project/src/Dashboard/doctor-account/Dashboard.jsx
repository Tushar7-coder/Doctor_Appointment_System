              ...
              {data && data.isApproved === "pending" && (
                <div className="flex mt-4 p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  <div className="ml-3 text-sm font-medium">
                    ...
                    review manually and approve it within 3days.
                  </div>
                </div>
              )}
              <div className="mt-8">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img
                          src={
                            data?.photo
                              ? data.photo
                              : "https://static.vecteezy.com/system/resources/previews/024/585/326/large_2x/3d-happy-cartoon-doctor-cartoon-doctor-on-transparent-background-generative-ai-png.png"
                          }
                          className="w-full"
                          alt=""
                        />
                      ...
                      <div>
                        ...
                        <h3 className="text-[22px] leading-9 font-bold mt-3 text-black">
                          {data?.name}
                        </h3>
                        ...
                        <p className="text-black font-[15px] lg:max-[390px] leading-6">
                          {data?.bio}
                        </p>
                      </div>
                    </div>
